...
NODE_OPTIONS=--openssl-legacy-provider make release ERL_CFLAGS="-I$PWD/js-1.8.5/js/src -I/usr/lib/erlang/usr/include" LIBRARY_PATH="$PWD/js-1.8.5/js/src/dist/lib"
